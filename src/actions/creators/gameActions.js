...
export const newPicRequest = () => dispatch => {
  return axios.get('https://api.unsplash.com/photos/random', {
    params: {
      client_id: '17827b0fcb9a2999e7090367d8ac0260c9127ef698ad80d8e2394ad25d238fea'
    }
  }).then( response => {
    if (response.data.urls.regular) dispatch(setPictureUrl(response.data.urls.regular))
    }
  ).catch(()=>{
